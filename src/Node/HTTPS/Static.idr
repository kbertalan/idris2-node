...
%foreign """
  ...
  """
ffi_createServer : HTTPS -> Node Net.CreateServer.Options -> Node TLS.CreateServer.Options -> Node TLS.CreateSecureContext.Options -> Node Node.HTTP.CreateServer.Options -> PrimIO Server
...
ffi_get : HTTPS -> String -> Node Node.HTTPS.Request.Options -> (IncomingMessage -> PrimIO ()) -> PrimIO ClientRequest
...
ffi_request : HTTPS -> String -> Node Node.HTTPS.Request.Options -> (IncomingMessage -> PrimIO ()) -> PrimIO ClientRequest
