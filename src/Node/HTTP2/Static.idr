...
ffi_createServer : HTTP2Module -> Node HTTP2.CreateServer.Command.Options -> PrimIO Http2Server

export
(.createServer) : HasIO io => HTTP2Module -> HTTP2.CreateServer.Command.Options -> io Http2Server
...
ffi_createSecureServer : HTTP2Module -> Node HTTP2.CreateSecureServer.Command.Options -> PrimIO Http2Server

export
(.createSecureServer) : HasIO io => HTTP2Module -> HTTP2.CreateSecureServer.Command.Options -> io Http2Server
...
ffi_connect : HTTP2Module -> String -> Node Connect.Options -> PrimIO ClientHttp2Session

export
(.connect) : HasIO io => HTTP2Module -> String -> Connect.Options -> io ClientHttp2Session
